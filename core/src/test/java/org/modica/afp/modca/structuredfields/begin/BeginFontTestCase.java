...
public class BeginFontTestCase extends StructuredFieldWithTripletsTestCase<BeginFont> {
    ...
    public void setUp() throws MalformedURLException, UnsupportedEncodingException {
        intro = StructuredFieldIntroducerTestCase.createGenericIntroducer(BeginType.BFN);

        List<Triplet> triplets = addTripletToList(
                FullyQualifiedNameTestCase.FONT_CHAR_SET_NAME_REF,
                FullyQualifiedNameTestCase.CODE_PAGE_NAME_REF);

        Parameters params = new Parameters(charsetName.getBytes(EbcdicStringHandler.DEFAULT_CPGID_NAME));
    ...
    public void testGetParameters() {
        ...
        expectedParams.add(new ParameterAsString("CharactersetName", charsetName));
